...
void SceneGL::UpdateCamera( const NeighborMesh& mesh, bool isDefault, Vector3d userPosition )
{
    Vector3d Center(0,0,0);
...
void SceneGL::UpdateLighting( bool isDefault, GLfloat a[4], GLfloat s[4], GLfloat d[4], GLfloat i)
