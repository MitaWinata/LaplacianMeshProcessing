...
public:
    ...
    void UpdateCamera( const NeighborMesh& mesh, bool isDefault, Vector3d userPosition );
   // void UpdateLighting( bool isDefault, GLfloat* am, GLfloat* spec, GLfloat* diff, GLfloat i);
    void UpdateLighting( bool isDefault, GLfloat a[4], GLfloat s[4], GLfloat d[4], GLfloat i);
